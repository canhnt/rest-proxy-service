...
/**
 * Represent an authenticated user provided by the access token
 */
public class AuthenticatedUser extends AbstractAuthenticationToken {
    public static final String ROLE_TKEXTRACTION = "ROLE_TKEXTRACTION";

    private final User user;

    public AuthenticatedUser(final User user) {
        super(Arrays.asList(new SimpleGrantedAuthority(ROLE_TKEXTRACTION)));
        this.user = user;
